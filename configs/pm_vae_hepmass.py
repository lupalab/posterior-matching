...
def get_config():
    ...
    config.model.decoder_dist_config.event_size = 21
    ...
    config.model.encoder_config.residual_blocks = 2
    config.model.encoder_config.hidden_units = 256
    config.model.encoder_config.layer_norm = False
    ...
    config.model.decoder_config.layer_norm = False
