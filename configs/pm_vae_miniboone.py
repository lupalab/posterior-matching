...
def get_config():
    ...
    config.model.decoder_dist_config.event_size = 43
    ...
    config.beta.period = 5000
    config.beta.delay = 2000
    ...
    config.lr_schedule.transition_steps = 1000
